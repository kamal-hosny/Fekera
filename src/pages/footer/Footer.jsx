      ...
      <div className="container md:w-4/5 w-full mx-auto flex flex-col gap-6">
        <div className="flex flex-col md:flex-row md:justify-between md:text-start md:items-start">
          ...
          <div className="md:mt-8 mt-4">
            <h2 className="title text-base font-bold text-hoverColorText">
              {t("Information")}
            </h2>
            <ul className="mt-4 flex flex-col gap-1">
              <Link
                to="/"
                className="p-1 transition-all hover:text-white hover:translate-x-2"
              >
                <li>{t("Sale")}</li>
              </Link>
              <Link to="/">
                <li className="p-1 transition-all hover:text-white hover:translate-x-2">
                  {t("About Us")}
                </li>
              </Link>{" "}
          ...
          <div className="md:mt-8 mt-4">
            <h2 className="text-base font-bold text-hoverColorText">
              {t("Contact Us")}
            </h2>
            <ul className="mt-4 flex flex-col gap-1">
              <li className="p-1 flex gap-2 items-center">
                <PhoneAndroidIcon className="text-colorText1" />
                <span>01013655708</span>
              </li>
              <li className="p-1 flex gap-2 items-center">
                <PhoneIcon className="text-colorText1" />
                <span>12345678</span>
              </li>
              <li className="p-1 flex gap-2 items-center">
                <MailIcon className="text-colorText1" />
          ...
          <div className="flex flex-col gap-4 md:mt-8 mt-4">
            <div>
              <h3 className="text-base font-bold text-hoverColorText">
                {t("Follow us on")}
              </h3>
              <div className=" mt-4 flex gap-3">
                <a
                  href=""
                  className="text-colorText1 hover:text-hoverColorText"
                >
                  <FacebookIcon />
                </a>
                <a
        ...
        <h1 className="text-center py-4">
          Developed by
          <span className="text-hoverColorText font-bold">
              Kamal Hosny
          </span>
        </h1>
      </div>
