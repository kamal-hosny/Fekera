...
import {
  ...
  specialOffers,
  topSellers,
} from "../../reduxToolkit/sale/saleSlice";
import { useEffect } from "react";
import { ColorRing } from "react-loader-spinner";

const Sale = () => {
  const dispatch = useDispatch();
  const { specialOffersData, specialOffersLoading } = useSelector((state) => state.sales);
  const { topSellersData, topSellersLoading } = useSelector((state) => state.sales);
  const { latestProductsData, latestProductsLoading } = useSelector((state) => state.sales);
